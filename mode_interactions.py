...
# PLOTTING
f, ax = plt.subplots()
ax.plot(sta_aloha_n2, sta_aloha_depth, label='ALOHA')
ax.plot(sta_papa_n2, sta_papa_depth, label='PAPA')
ax.plot(dg_N2, dg_depth, label='BATS DG')
ax.plot(this_ship_n2, ship_depth, label='ABACO')
ax.plot(argo_N2, argo_depth, label='Argo Atl')
ax.plot(argo2_N2, argo2_depth, label='Argo NZ')
