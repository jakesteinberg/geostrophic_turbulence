...
G_B_0, Gz_B_0, c_B_0, epsilon_B_0 = vertical_modes(sta_bats_n2_0, SB['depth'], omega, mmax)
# summer
...
# winter
sta_bats_n2_3 = SB['N2_per_season'][:, 3]
G_B_3, Gz_B_3, c_B_3, epsilon_B_3 = vertical_modes(sta_bats_n2_3, SB['depth'], omega, mmax)
...
ax0.plot(sta_bats_n2_2, sta_bats_depth, label='BATS Ship', color='#00FF7F')
...
ax1.plot(Gz_B_1[:, 1], sta_bats_depth, label='BATS Ship (32$^{\circ}$N) (Mode$_1$ SI = ' + str(np.round(epsilon_B_1[1, 1, 1], 2)) + ')', color='#00FF7F')
...
plt.xticks(np.arange(0.5, 3.5, 1), ('0', '1', '2'))
plt.yticks(np.arange(0.5, 3.5, 1), ('0', '1', '2'))
arm[0, 3].pcolor(epsilon_B_1[0, :, :], cmap=cmap, vmin=vmi, vmax=vma)
arm[0, 3].set_title('BATS Ship Sum mode 0', fontsize=fs)
plt.xticks(np.arange(0.5, 3.5, 1), ('0', '1', '2'))
plt.yticks(np.arange(0.5, 3.5, 1), ('0', '1', '2'))
arm[0, 4].pcolor(epsilon_B_3[0, :, :], cmap=cmap, vmin=vmi, vmax=vma)
arm[0, 4].set_title('BATS Ship Win mode 0', fontsize=fs)
plt.xticks(np.arange(0.5, 3.5, 1), ('0', '1', '2'))
plt.yticks(np.arange(0.5, 3.5, 1), ('0', '1', '2'))
...
plt.xticks(np.arange(0.5, 3.5, 1), ('0', '1', '2'))
plt.yticks(np.arange(0.5, 3.5, 1), ('0', '1', '2'))
arm[1, 3].pcolor(epsilon_B_1[1, :, :], cmap=cmap, vmin=vmi, vmax=vma)
arm[1, 3].set_title('BATS Ship Sum mode 1', fontsize=fs)
plt.xticks(np.arange(0.5, 3.5, 1), ('0', '1', '2'))
plt.yticks(np.arange(0.5, 3.5, 1), ('0', '1', '2'))
arm[1, 4].pcolor(epsilon_B_3[1, :, :], cmap=cmap, vmin=vmi, vmax=vma)
arm[1, 4].set_title('BATS Ship Win mode 1', fontsize=fs)
plt.xticks(np.arange(0.5, 3.5, 1), ('0', '1', '2'))
plt.yticks(np.arange(0.5, 3.5, 1), ('0', '1', '2'))
...
plt.xticks(np.arange(0.5, 3.5, 1), ('0', '1', '2'))
plt.yticks(np.arange(0.5, 3.5, 1), ('0', '1', '2'))
arm[2, 3].pcolor(epsilon_B_1[2, :, :], cmap=cmap, vmin=vmi, vmax=vma)
arm[2, 3].set_title('BATS Ship Sum mode 2', fontsize=fs)
plt.xticks(np.arange(0.5, 3.5, 1), ('0', '1', '2'))
plt.yticks(np.arange(0.5, 3.5, 1), ('0', '1', '2'))
arm[2, 4].pcolor(epsilon_B_3[2, :, :], cmap=cmap, vmin=vmi, vmax=vma)
arm[2, 4].set_title('BATS Ship Win mode 2', fontsize=fs)
plt.xticks(np.arange(0.5, 3.5, 1), ('0', '1', '2'))
plt.yticks(np.arange(0.5, 3.5, 1), ('0', '1', '2'))
