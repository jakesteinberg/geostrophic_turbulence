...
y_dg_s = 6000  # horizontal position, start of glider dives (75km)
...
# plot_pro(ax)
# ---------------------------------------------------------------------------------------------------------------------
# -- model densities at fixed depths --
...
if save_anom:
    ...
    output = open('/Users/jake/Documents/baroclinic_modes/Model/eddy_velocity_anomalies_' + tag + '_in.pkl', 'wb')
