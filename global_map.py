...
ax.text(-74,25.5,'ABACO',color='k',fontsize=8, transform=ccrs.PlateCarree())
# ARGO
ax.scatter([-74], [24], color='r',s=7, transform=ccrs.PlateCarree(),zorder=3)
ax.text(-71,23,'Deep Argo',color='k',fontsize=8, transform=ccrs.PlateCarree())
# ARGO
...
ax.text(-63.2,30.6,'BATS',color='k',fontsize=8, transform=ccrs.PlateCarree())
# PAPA 
ax.scatter([-145], [50], color='k',s=7, transform=ccrs.PlateCarree(),zorder=3)
ax.text(-144,49,'PAPA',color='k',fontsize=8, transform=ccrs.PlateCarree())
# HOTS 
ax.scatter([-158], [22.75], color='k',s=7, transform=ccrs.PlateCarree(),zorder=3)
ax.text(-157,21.75,'ALOHA',color='k',fontsize=8, transform=ccrs.PlateCarree())
...
plt.savefig('/Users/jake/Desktop/abaco/map.png',dpi = 300)
