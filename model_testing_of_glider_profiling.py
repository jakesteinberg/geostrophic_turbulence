...
# --- PLOT
# f, ax = plt.subplots()
# ax.pcolor(lat_rho[lat_select_i, lon_select_i], z[:, lat_select_i, lon_select_i], t[:, lat_select_i, lon_select_i],
#           vmin=1, vmax=13)
# uvc = ax.contour(np.tile(lat_u[lat_select_i,lon_select_i], (len(z), 1)), z[:, lat_select_i, lon_select_i],
#                  u[:, lat_select_i, lon_select_i],
