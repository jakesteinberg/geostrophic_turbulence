...
# --- LOAD
file_list = glob.glob('/boildat1/parker/LiveOcean_roms/output/cas4_v2_lo6biom/f2018.11.24/ocean_his_0*.nc')
...
for i in range(len(file_list)):
    ...
    output = open('/home/jstein/E_W_nov22_nov24_offshore/E_W_ext_' + date_str_out + '.pkl', 'wb')
