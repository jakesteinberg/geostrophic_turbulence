...
in_x2 = np.where( (x_g > 25) & (x_g < 50))
in_z2 = np.where( (z_g < 0) & (z_g > -1000) )
in_x3 = np.where( (x_g > 25) & (x_g < 50))
...
V[in_z2[0][0]:in_z2[0][-1], in_x2[0][0]:in_x2[0][-1]] = -1*A*np.sin((2*np.pi/50)*X[ in_z2[0][0]:in_z2[0][-1], in_x2[0][0]:in_x2[0][-1] ])*B*np.cos((2*np.pi/4000)*Z[ in_z2[0][0]:in_z2[0][-1], in_x2[0][0]:in_x2[0][-1] ])
...
levels=np.concatenate((np.arange(-7,0,.25), np.arange(0,8,1)))
...
ax.plot3D(-10*np.ones(np.size(grid[1:])),y_pos2 + 3*Gz[:,0],np.flipud(np.linspace(-5000,0,np.size(grid[1:]))),color='#6A5ACD',zdir='z',linewidth=0.75)
ax.plot3D(-10*np.ones(np.size(grid[1:])),y_pos2 + 3*Gz[:,1],np.flipud(np.linspace(-5000,0,np.size(grid[1:]))),color='#6A5ACD',zdir='z',linewidth=0.75)
ax.plot3D(-10*np.ones(np.size(grid[1:])),y_pos2 + 3*Gz[:,2],np.flipud(np.linspace(-5000,0,np.size(grid[1:]))),color='#6A5ACD',zdir='z',linewidth=0.75)
