...
x = Glider(30, np.arange(58, 66), '/Users/jake/Documents/Cuddy_tailored/DG_wa_coast/2006')
...
ds, dist, v_g, vbt, isopycdep, isopycx, sigth_levels, mwe_lon, mwe_lat = x.transect_cross_section(
    bin_depth, sig0, lon, lat, dac_u, dac_v, profile_tags)
...
x.plot_plan_view(mwe_lon, mwe_lat, dac_u, dac_v, ref_lat, [-129, -123.5, 46.5, 48.5], bathy_path)
